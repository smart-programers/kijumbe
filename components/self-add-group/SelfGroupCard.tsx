...
const getStatusStyle = (status: Group['status']) => {
    switch (status) {
        case 'active':
...
export default function SelfGroupCard({ group,onPress }: GroupCardProps) {
                ...
                <Card.Content style={styles.cardContent}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <View style={styles.infoItem}>
                            ...
                            <Text style={styles.infoValue}>{group.member.length || 0}/{group.memberLimit || 'N/A'}</Text>
                        </View>
                    </View>
